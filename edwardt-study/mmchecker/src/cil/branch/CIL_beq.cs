...
namespace mmchecker
{
	...
	/// </summary>
	public class CIL_beq : CILInstruction
	{
		string branchLabel;

		public CIL_beq(string label, string branchLabel) : base(label)
		{
